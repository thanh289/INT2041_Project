            ...
            <div className="flex-1 flex flex-col p-4 lg:p-8 space-y-6 lg:space-y-8">
                ...
                >
                    <div className="flex flex-col items-center justify-center w-full h-full">
                        ...
                        <span className={`text-4xl font-black uppercase tracking-widest text-center w-full transition-colors ${isMicrophoneEnabled ? "text-green-400 drop-shadow-[0_0_8px_rgba(74,222,128,0.5)]" : "text-red-400 opacity-80"
                            }`}>
