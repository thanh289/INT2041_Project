    ...
    >
      <h2 
        className={`text-4xl md:text-6xl font-black tracking-widest uppercase transition-colors duration-500 text-center ${
          agentParticipant ? 'text-yellow-400 drop-shadow-[0_0_20px_rgba(250,204,21,0.5)]' : 'text-cyan-400 drop-shadow-[0_0_20px_rgba(34,211,238,0.5)]'
        }`}
        aria-live="polite"
      >
...
function HomeTab() {
  ...
  return (
    <div className="flex-1 w-full h-full p-6 flex flex-col items-center justify-center relative overflow-hidden">
        ...
        <div className={`absolute inset-0 z-0 transition-opacity duration-500 flex items-center justify-center ${
